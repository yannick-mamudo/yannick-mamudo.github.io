!function(e, t, n) {
    ...
    function s(e) {
        ...
        for (this._rules = []; t = e[n++]; )
            this._rules.push(new a(t))
    }
    function a(e) {
        this._rule = e
    }
    function u(e) {
        return this instanceof u ? (this._options = e,
        e.keywords || (this._options = {
            keywords: e
        }),
        this._promise = [],
        ...
        void this._addMediaListeners()) : new u(e)
    }
    var l = RegExp("^" + String({}.valueOf).replace(/[.*+?\^${}()|\[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$")
      ...
      , h = function() {
        ...
        function r(e) {
            ...
            h.onreadystatechange = function() {
                4 != h.readyState || 200 != h.status && 304 != h.status || (u[e] = h.responseText,
                l.shift(),
                n())
            }
            ,
      ...
      , d = {
        ...
        parse: function(e, t) {
            ...
            return t && d._cache[t] ? d._cache[t] : (e = e.replace(/\/\*[\s\S]*?\*\//g, ""),
            d._cache[t] = o())
        },
        filter: function(e, t) {
            function n(e, t) {
            ...
            function i(e) {
                null == e.media && delete e.media,
                null == e.supports && delete e.supports,
                c.push(e)
            }
            function o(e, t) {
                if (t)
            ...
            function s(e, t) {
                for (var n, i, o, s, a = /\*/, u = 0; n = t[u++]; )
                    if (i = n.split(":"),
                    o = new RegExp("^" + r(i[0]).replace(a, ".*") + "$"),
                    s = new RegExp("^" + r(i[1]).replace(a, ".*") + "$"),
                    o.test(e.property) && s.test(e.value))
                        return !0
            }
            function a(e, n, r) {
            ...
            function l(e, t, r) {
                for (var i, o = 0; i = e[o++]; )
                    i.declarations ? a(i, t, r) || u(i, t, r) : i.rules && i.media ? l(i.rules, n(t, i.media), r) : i.rules && i.supports && l(i.rules, t, n(r, i.supports))
            }
            var c = [];
            return l(e),
            c
      ...
      , p = function() {
        ...
        function i(e) {
            var r, i, o = !1;
            return s = t.documentElement.clientWidth,
            a.test(e) && (r = "em" === RegExp.$2 ? parseFloat(RegExp.$1) * n() : parseFloat(RegExp.$1)),
            u.test(e) && (i = "em" === RegExp.$2 ? parseFloat(RegExp.$1) * n() : parseFloat(RegExp.$1)),
            r && i ? o = s >= r && i >= s : (r && s >= r && (o = !0),
            i && i >= s && (o = !0)),
            {
                matches: o,
                media: e
        ...
        var o, s, a = /\(min\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/, u = /\(max\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/, l = {};
        return {
            matchMedia: function(e) {
                return f.matchMedia ? r(e) : i(e)
            },
            clearCache: function() {
                f.nativeMatchMedia || (s = null ,
                l = {})
            }
        }
    }()
      , m = function() {
        ...
        var n = function() {
            ...
            return {
                add: function(t, n, r) {
                    for (var i, o = 0; i = e[o++]; )
                        if (i.polyfill == t && i.mql === n && i.fn === r)
                            return !1;
                    n.addListener(r),
                    e.push({
                        polyfill: t,
                ...
                remove: function(t) {
                    for (var n, r = 0; n = e[r++]; )
                        n.polyfill === t && (n.mql.removeListener(n.fn),
                        e.splice(--r, 1))
                }
            }
        }()
          , r = function(t) {
            ...
            return {
                add: function(r, i) {
                    t.length || (e.addEventListener ? e.addEventListener("resize", n, !1) : e.attachEvent("onresize", n)),
                    t.push({
                        polyfill: r,
                        fn: i
                    })
            ...
            addListeners: function(e, i) {
                function o() {
                    if (f.nativeMatchMedia)
                        for (var o in a)
                            a.hasOwnProperty(o) && !function(t, r) {
                                n.add(e, t, function() {
                ...
                function s(e, t) {
                    ...
                    p.clearCache();
                    for (n in t)
                        t.hasOwnProperty(n) && (r[n] = p.matchMedia(n).matches,
                        r[n] != u[n] && i.call(e, n, p.matchMedia(n).matches));
                    u = r
                }
                ...
                !function() {
                    for (var e in a)
                        a.hasOwnProperty(e) && (u[e] = p.matchMedia(e).matches)
                }(),
                o()
            }
        }
    ...
    u.prototype.doMatched = function(e) {
        return this._doMatched = e,
        this._resolve(),
        this
    }
    ,
    u.prototype.undoUnmatched = function(e) {
        return this._undoUnmatched = e,
        this._resolve(),
        this
    }
    ,
    u.prototype.getCurrentMatches = function() {
        for (var e, t, n = 0, r = []; e = this._filteredRules[n++]; )
            t = e.media && e.media.join(" and "),
            (!t || p.matchMedia(t).matches) && r.push(e);
        return new s(r)
    }
    ,
    ...
    u.prototype._resolve = function() {
        for (var e, t = 0; e = this._promise[t]; )
            e.condition.call(this) ? (this._promise.splice(t, 1),
            e.callback.call(this)) : t++
    }
    ,
    u.prototype._getStylesheets = function() {
        var e, n, r, o, s, a, u, l = 0, f = [];
        if (this._options.include) {
            for (n = this._options.include; e = n[l++]; )
                if (r = t.getElementById(e)) {
                    ...
                    if (r.media && "print" == r.media)
                        continue;if (!c(r.href))
                        continue;u = {
                        href: r.href
                    },
                    r.media && (u.media = r.media),
                    f.push(u)
                }
        } else {
            for (n = this._options.exclude,
            o = t.getElementsByTagName("link"); r = o[l++]; )
                r.rel && "stylesheet" == r.rel && "print" != r.media && c(r.href) && !i(r.id, n) && (u = {
                    href: r.href
                },
                r.media && (u.media = r.media),
                f.push(u));
            for (a = t.getElementsByTagName("style"),
            l = 0; s = a[l++]; )
                u = {
                    text: s.textContent
                },
    ...
    u.prototype._buildMediaQueryMap = function() {
        this._defer(function() {
            ...
            for (this._mediaQueryMap = {}; t = this._filteredRules[n++]; )
                t.media && (e = t.media.join(" and "),
                this._mediaQueryMap[e] = p.matchMedia(e))
        })
    }
    ,
    ...
    u.prototype._addMediaListeners = function() {
        this._defer(function() {
            ...
            m.addListeners(this, function(e, t) {
                for (var n, r = 0, i = [], o = []; n = this._filteredRules[r++]; )
                    n.media && n.media.join(" and ") == e && (t ? i : o).push(n);
                i.length && this._doMatched(new s(i)),
                o.length && this._undoUnmatched(new s(o))
            })
        })
    }
    ,
...
function(e, t, n) {
    ...
    function o(e, n) {
        if ("undefined" != typeof n["scroll-snap-coordinate"])
            return e.snapLengthUnit = p(n),
            a(e);
        var r = e.tagName;
        ("body" == r.toLowerCase() || "html" == r.toLowerCase()) && (e = t),
        e.addEventListener("scroll", q, !1),
        "undefined" != typeof n["scroll-snap-destination"] ? e.snapLengthUnit = p(n) : e.snapLengthUnit = d(n),
        e.snapElements = []
    }
    function s(e) {
        var n = e.tagName;
        ("body" == n.toLowerCase() || "html" == n.toLowerCase()) && (e = t),
        e.removeEventListener("scroll", q, !1),
        e.snapLengthUnit = null ,
        e.snapElements = []
    }
    function a(e) {
        for (var t = e; e && e !== document; e = e.parentNode)
            "undefined" != typeof e.snapElements && e.snapElements.push(t)
    }
    function u(e, t, n) {
        var r = {
        ...
        u.y = c(n.y, s.y),
        u.x = c(n.x, s.x),
        u.y = f(a.y, s.y, u.y, z.y, i),
        u.x = f(a.x, s.x, u.x, z.x, o);
        var l = {
            y: u.y * r.y,
            x: u.x * r.x
        };
        return l.y = h(0, v(e), l.y),
        l.x = h(0, x(e), l.x),
        l
    }
    function l(e, t, n) {
    ...
    function d(e) {
        ...
        return "undefined" !== e["scroll-snap-points-y"] && (t = n.exec(e["scroll-snap-points-y"]),
        null !== t && (r.y = {
            value: t[1],
            unit: t[2]
        })),
        "undefined" !== e["scroll-snap-points-x"] && (t = n.exec(e["scroll-snap-points-x"]),
        null !== t && (r.x = {
            value: t[1],
            unit: t[2]
        })),
    ...
    function p(e) {
        ...
        return "undefined" != typeof e["scroll-snap-coordinate"] ? t = "scroll-snap-coordinate" : "undefined" != typeof e["scroll-snap-destination"] && (t = "scroll-snap-destination"),
        null !== t && (n = r.exec(e[t]),
        null !== n && (i.y = {
            value: n[1],
            unit: n[2]
    ...
    if (!("scrollSnapType"in t.documentElement.style || "webkitScrollSnapType"in t.documentElement.style || "msScrollSnapType"in t.documentElement.style)) {
        var b, N, U = null , z = null , q = function(e) {
            b = e.target,
            N = M(b),
            j && (cancelAnimationFrame(j) || clearTimeout(j)),
            U ? clearTimeout(U) : z = {
                y: N.scrollTop,
                x: N.scrollLeft
            },
        ...
        , $ = function() {
            if (z.y != N.scrollTop || z.x != N.scrollLeft) {
                ...
                e = "undefined" != typeof N.snapElements && N.snapElements.length > 0 ? l(N, b, t) : u(N, b, t),
                b.removeEventListener("scroll", q, !1),
                O(N, e, function() {
        ...
        , k = null , A = 0, F = function(e) {
            return e * e * e
        }
        , H = function(e, t, n, r) {
            return n > r ? t : e + (t - e) * F(n / r)
        }
        , j = null , O = function(t, n, r) {
            var i = {
                y: t.scrollTop,
                x: t.scrollLeft
            }
              ...
              , u = function() {
                var e = Date.now() - o;
                if (isNaN(n.y) || (t.scrollTop = H(i.y, n.y, e, a)),
                isNaN(n.x) || (t.scrollLeft = H(i.x, n.x, e, a)),
                e > a) {
